...
function getSentence(config, randomFunc = getRandomIndex) {
  ...
  let isAdjective =
    pickedAdjective.forms[adjDefOrIndef][objectGender][adjSingOrPlur][
      verbGrammar
    ];
  ...
  if (useAdj) {
    if (pickedFormIndex === 0) {
      ...
      enSentence =
        enSubject + " " + enVerb + " " + enAdjective + " " + enObject;
    } else if (pickedFormIndex === 2) {
      enSentence =
        enSubject + " " + enVerb + " " + "the " + enAdjective + " " + enObject;
    } else if (pickedFormIndex === 3) {
      enSentence =
        enSubject + " " + enVerb + " " + "the " + enAdjective + " " + enObject;
    }
    ...
    if (pickedFormIndex === 0) {
      enSentence =
        enSubject + " " + enVerb + " " + pickedObj.article + " " + enObject;
    } else if (pickedFormIndex === 1) {
